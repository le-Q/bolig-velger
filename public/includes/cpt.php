...
class DrawAttention_CPT {
	...
	function register_cpt() {
		$result = register_post_type( $this->post_type, /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
			...
			array('labels' => array(
				'name' => __('Boligvelger', $this->post_type.' general name', 'bolig-velger' ), /* This is the Title of the Group */
				'singular_name' => __('Blokk', $this->post_type.' singular name', 'bolig-velger' ), /* This is the individual type */
				'all_items' => __('Alle Blokk', 'bolig-velger' ), /* the all items menu item */
				'add_new' => __('Legg til ny', 'custom '.$this->post_type.' item', 'bolig-velger' ), /* The add new menu item */
				'add_new_item' => __('Legg til blokk', 'bolig-velger' ), /* Add New Display Title */
				'edit' => __( 'Edit' ), /* Edit Dialog */
				'edit_item' => __('Endre blokk', 'bolig-velger' ), /* Edit Display Title */
				'new_item' => __('Nytt blokk', 'bolig-velger' ), /* New Display Title */
				'view_item' => __('Vis blokk', 'bolig-velger' ), /* View Display Title */
				'search_items' => __('Søkte blokk', 'bolig-velger' ), /* Search CPT_SINGULAR_NAME Title */
