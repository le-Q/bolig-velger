(function (e) {
  ...
  var t = navigator.userAgent.toLowerCase(),
    n = t.indexOf("chrome") > -1 && (t.indexOf("windows") > -1 || t.indexOf("macintosh") > -1 || t.indexOf("linux") > -1) && t.indexOf("mobile") < 0 && t.indexOf("android") < 0,
    r = {
      tap_pixel_range: 5,
      ...
      n.on(r.startevent, function (e) {
        if (e.which && e.which !== 1) {
          ...
          r.hold_timer = window.setTimeout(function () {
            var h = o.x - u,
              p = o.y - a;
            if (e.target == i && (o.x == u && o.y == a || h >= -r.tap_pixel_range && h <= r.tap_pixel_range && p >= -r.tap_pixel_range && p <= r.tap_pixel_range)) {
              n.data("tapheld", true);
              var d = Date.now(),
                v = {
                  x: r.touch_capable ? s.touches[0].screenX : e.screenX,
        ...
        u = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX;
  ...
  e.event.special.doubletap = {
    setup: function () {
      ...
      n.on(r.startevent, function (e) {
        ...
        var u = Date.now();
        var l = n.data("lastTouch") || u + 1;
        var c = u - l;
        window.clearTimeout(s);
        n.data("callee2", arguments.callee);
        if (c < r.doubletap_int && e.target == i && c > 100) {
          ...
          var p = {
            firstTap: o,
            secondTap: h,
            interval: h.time - o.time
          };
          if (!f) {
            E(t, "doubletap", e, p)
          }
          f = true;
          a = window.setTimeout(function (e) {
            f = false
          }, r.doubletap_int)
        } else {
          n.data("lastTouch", u);
    ...
    setup: function () {
      ...
      n.on(r.startevent, function (e) {
        ...
        if (e.which && e.which !== 1) {
          ...
          o = Date.now();
          s = e.target;
          a = e.originalEvent.targetTouches ? e.originalEvent.targetTouches : [e];
          return true
        }
      }).on(r.endevent, function (e) {
        n.data("callee2", arguments.callee);
        var f = e.originalEvent.targetTouches ? e.originalEvent.changedTouches[0].pageX : e.pageX,
          ...
          h = u.y - l,
          p;
        if (s == e.target && i && Date.now() - o < r.taphold_threshold && (u.x == f && u.y == l || c >= -r.tap_pixel_range && c <= r.tap_pixel_range && h >= -r.tap_pixel_range && h <= r.tap_pixel_range)) {
          var d = e.originalEvent;
          var v = [];
          for (var m = 0; m < a.length; m++) {
            var g = {
              position: {
                x: r.touch_capable ? d.changedTouches[m].screenX : e.screenX,
                y: r.touch_capable ? d.changedTouches[m].screenY : e.screenY
              },
              offset: {
                x: r.touch_capable ? d.changedTouches[m].pageX - d.changedTouches[m].target.offsetLeft : e.offsetX,
                y: r.touch_capable ? d.changedTouches[m].pageY - d.changedTouches[m].target.offsetTop : e.offsetY
              },
              time: Date.now(),
              target: e.target
            };
  ...
  if (r.orientation_support) {
    var c = window.innerWidth || i.width(),
      h = window.innerHeight || i.height(),
      p = 50;
    a = c > h && c - h > p;
