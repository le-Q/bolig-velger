 ...
 * @author  Nathan Tyler <support@tylerdigital.com>
 */
if ( !class_exists( 'BoligVelger_Admin' ) ) {
	class BoligVelger_Admin {
		...
		private function __construct() {
			 ...
			 */
			$this->da = BoligVelger::get_instance();
		...
		public function enqueue_admin_styles() {
			...
			if ( $this->da->cpt->post_type==$screen->post_type || $this->plugin_screen_hook_suffix == $screen->id ) {
				wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), BoligVelger::VERSION );
			}
